...
// GPIOA
void GPIOA_PA2_AF_Mode(void);				// set 10 at MODER2 bit pos to select Alternate function mode for pin PA2
void GPIOA_PA3_AF_Mode(void);				// set 10 at MODER3 bit pos to select Alternate function mode for pin PA3
// GPIOB
void GPIOB_PB6_AF_Mode(void);				// set 10 at MODER6 bit pos to select Alternate function mode for pin PB6
void GPIOB_PB7_AF_Mode(void);				// set 10 at MODER7 bit pos to select Alternate function mode for pin PB7
...
void GPIOC_PC2_AF5_SPI2(void);			// Set 4 = 0101 at AFRL2 bit positions to select AF5 as SPI2_MISO for pin PC2 in the AFRL Register
void GPIOC_PC7_AF5_SPI2(void);			// Set 4 = 0101 at AFRL7 bit positions to select AF5 as SPI2_SCK for pin PC7 in the AFRL Register
...
// GPIOC
void GPIOC_PC1_OTYPE_Open_Drain(void);		// set 1 at bit pos OT1 to configure open drain for PC1 pin
void GPIOC_PC2_OTYPE_Open_Drain(void);		// set 1 at bit pos OT2 to configure open drain for PC2 pin
void GPIOC_PC7_OTYPE_Open_Drain(void);		// set 1 at bit pos OT7 to configure open drain for PC7 pin
